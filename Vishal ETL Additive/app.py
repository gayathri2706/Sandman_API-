...
@app.route('/api/mixer-report', methods=['GET'])
def get_mixer_report():
    try:
        ...
        # Get total count
        count_query = f"SELECT COUNT(*) as total FROM mixer_report_test {where_clause}"
